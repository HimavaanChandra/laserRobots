...
ttk.Label(mainframe, textvariable=mcqueenhp1, width=10).grid(column=1, row=3, sticky=(W, E))
ttk.Label(mainframe, textvariable=mcqueenhp2, width=10).grid(column=2, row=3, sticky=(W, E))
ttk.Label(mainframe, textvariable=mcqueenhp3, width=10).grid(column=3, row=3, sticky=(W, E))
ttk.Label(mainframe, textvariable=mcqueenhp4, width=10).grid(column=4, row=3, sticky=(W, E))
ttk.Label(mainframe, textvariable=mcqueenhp5, width=10).grid(column=5, row=3, sticky=(W, E))
ttk.Label(mainframe, textvariable=mcqueenhp6, width=10).grid(column=6, row=3, sticky=(W, E))
ttk.Label(mainframe, textvariable=mcqueenhp7, width=10).grid(column=7, row=3, sticky=(W, E))
ttk.Label(mainframe, textvariable=mcqueenhp8, width=10).grid(column=8, row=3, sticky=(W, E))
ttk.Label(mainframe, textvariable=mcqueenhp9, width=10).grid(column=9, row=3, sticky=(W, E))
ttk.Label(mainframe, textvariable=mcqueenhp10, width=10).grid(column=10, row=3, sticky=(W, E))

ttk.Label(mainframe2, textvariable=thomashp1, width=10).grid(column=1, row=3, sticky=(W, E))
ttk.Label(mainframe2, textvariable=thomashp2, width=10).grid(column=2, row=3, sticky=(W, E))
ttk.Label(mainframe2, textvariable=thomashp3, width=10).grid(column=3, row=3, sticky=(W, E))
ttk.Label(mainframe2, textvariable=thomashp4, width=10).grid(column=4, row=3, sticky=(W, E))
ttk.Label(mainframe2, textvariable=thomashp5, width=10).grid(column=5, row=3, sticky=(W, E))
ttk.Label(mainframe2, textvariable=thomashp6, width=10).grid(column=6, row=3, sticky=(W, E))
ttk.Label(mainframe2, textvariable=thomashp7, width=10).grid(column=7, row=3, sticky=(W, E))
ttk.Label(mainframe2, textvariable=thomashp8, width=10).grid(column=8, row=3, sticky=(W, E))
ttk.Label(mainframe2, textvariable=thomashp9, width=10).grid(column=9, row=3, sticky=(W, E))
ttk.Label(mainframe2, textvariable=thomashp10, width=10).grid(column=10, row=3, sticky=(W, E))
